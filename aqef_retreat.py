...
for dtt in dtt_vec:
    output_folder = "dtt."+str(dtt)+"_tend."+str(t_end)
    cmd = "./runylmox -r -e ismip6 -n par/yelmo_ismip6_Antarctica_AQEF_regrowth.nml -o output/aqef_retreat/"+output_folder
    cmd+= " -p tf_corr_ant.ronne=0.25 tf_corr_ant.ross=0.2 tf_corr_ant.pine=-0.5"
    cmd+=" yelmo.restart=\"/home/jan/yelmo-ucm/yelmox_v1.662/output/controlrun/H_w_max.2.0_tend.10000.0/yelmo_restart.nc\""
