...
param_dict["hysteresis.dt2D_small_out"] = 2e2       # [yr]
param_dict["hyster.dt_init"] = 10e3                 # [yr]
param_dict["hyster.df_dt_max"] = 5e-4               # [K/yr]
param_dict["hyster.f_min"] = 0.0                    # [K]
param_dict["hyster.f_max"] = 5.0                    # [K]  
...
cmd+= " -p yelmo.grid_name=\"ANT-16KM\" ctrl.run_step=\"hysteresis_proj\" yelmo.restart=\"/home/jan/yelmo-ucm/yelmox_v1.75/output/spinup_16km/yelmo_restart.nc\" hyster.method=\"PI42\""
